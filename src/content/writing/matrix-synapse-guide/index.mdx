...
<Replacer string="domain.tld" label="Replace it with your domain here:" placeholder="your-domain.tld" id="domain" client:load>
...
At this point, give the [Matrix Federation Tester](https://federationtester.matrix.org/) a whirl by entering `domain.tld`. This tool checks if your server is reachable on the expected ports.
