...
<Replacer string="nvme0n1" label="Replace it with your drive name here:" placeholder="nvme0n1/sda" enableDiskReplacement={true} id="disk" client:load>
...
<Replacer string="artixmachine" label="Replace it with your desired hostname:" placeholder="artixmachine" id="hostname" client:load>
...
<Replacer string="artixuser" label="Change `artixuser` to your desired username" placeholder="artixuser" id="user" client:load>
